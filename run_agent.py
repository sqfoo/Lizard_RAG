...
from core.llm import GEMINI, HUGGINGFACE
...
agent = Agent(primary_LLM=HUGGINGFACE, backup_LLM=GEMINI, tools=TOOLBOX, sys_prompt=GENERAL_PROMPT, keywords=["FINAL ANSWER"], extract=True)
agent.visualize()
